...
def draw_clouds(center_of_the_fisrt_cloud_x, center_of_the_first_cloud_y,
    ...
    for i in range(number_of_clouds_1):
        draw_an_ellipse(center_cloud_1_x, center_cloud_1_y, cloud_radius_x, cloud_radius_y)
    ...
    for i in range(number_of_clouds_2):
        draw_an_ellipse(center_cloud_2_x, center_cloud_2_y, cloud_radius_x, cloud_radius_y)
...
cloud_1_radius_x = 14
cloud_1_radius_y = 14
draw_clouds(center_of_the_fisrt_cloud_1_x, center_of_the_first_cloud_1_y,
...
cloud_2_radius_x = 24
cloud_2_radius_y = 27
draw_clouds(center_of_the_fisrt_cloud_2_x, center_of_the_first_cloud_2_y,
...
cloud_3_radius_x = 22
cloud_3_radius_y = 15
draw_clouds(center_of_the_fisrt_cloud_3_x, center_of_the_first_cloud_3_y,
...
umbrella_2_triangle_base = 53 
umbrella_2_triangle_height = 20
...
def draw_a_ship(ship_bow_x, ship_size):
    ship_bow_y = sea_upper_left_point_y + ship_size * (225 - sea_upper_left_point_y)#221
